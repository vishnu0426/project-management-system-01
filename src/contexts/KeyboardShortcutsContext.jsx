...
export const KeyboardShortcutsProvider = ({ children }) => {
  ...
  // Memoize default shortcuts to prevent recreation on every render
  ...
  // Move triggerAction outside of defaultShortcuts to avoid circular dependency
  ...
  }, []); // Remove defaultShortcuts dependency
  ...
  }, [keySequence, sequenceTimeout, actionHandlers, navigate, defaultShortcuts, triggerAction]);
  ...
  const value = useMemo(() => ({
    ...
    triggerAction
  }), [shortcuts, keySequence, isHelpModalOpen, registerActionHandler, unregisterActionHandler, triggerAction]);

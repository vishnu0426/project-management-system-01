...
const TeamMembers = () => {
  ...
  useEffect(() => {
    ...
    loadUserAndOrgData();
  }, [currentUser?.email, currentUser?.firstName, currentUser?.lastName, userRole]);
  ...
  useEffect(() => {
    ...
    loadTeamMembers();
  }, [currentOrganization, searchQuery, roleFilter, currentUser?.email, currentUser?.firstName, currentUser?.lastName, userRole]);
